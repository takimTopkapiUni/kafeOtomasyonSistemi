...
import 'package:kafe_uygulamasi/pages/RezervePage3.dart';
import '../pages/RezervePage.dart';

//*Masaları oluşturduğumuz Widget
class MasaOlustur3 extends StatelessWidget {
  const MasaOlustur3({Key? key, required this.masaNo, required this.doluMu})
      : super(key: key);
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const RezervePage3()));
